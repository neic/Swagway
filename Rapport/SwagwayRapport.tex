...
\chapter{Indledning}\label{chap:ind} \fnnote{indsæt pic af swagway}
...
\begin{figure}[htbp]
  ...
  \label{fig:imu}
\end{figure}
IMUen fra Sparkfun et ADXL345 accelerometer og et ITG-3200 gyroskop. Accelerometret og gyroskopet er begge tre-akset. \fxnote{tre-akset?} Det giver IMUen seks frihedsgrader (DOF).
\subsection{I²C}
\fxnote{I²C, wire.h, libraries}
