...
Måden vi styre dette på i en Arduino er via \lstinline{analogWrite(pin,\dots);}. Her har vi mulighed for at give en værdi fra 0--255. Dette betyder at \lstinline{analogWrite(pin,255);} er 100\% og \lstinline{analogWrite(pin,127);} er 50\%. Dette kan også ses på figur \ref{fig:pwm}.\fxwarning{Hele afsnittet skal omskrives}
\begin{figure}[htbp]
  \centering
...
\begin{figure}[htbp]
  ...
  \caption[Tidligere versioner af Motorcontrolleren]{Tidligere versioner af Motorcontrolleren. Øverste række fra venstre: v1.0, v2.1, v3.0. Nederst række fra venstre: v?.?, v5.2, v6.0}
  \label{fig:oldmotor}
\end{figure}
\chapter{Auxiliary}
\begin{table}[htbp]
